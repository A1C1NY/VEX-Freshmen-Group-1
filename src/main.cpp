...
pidParams fwd_pid(3.0, 0.1, 0.05, 0.5, 1.0, 10, 10),  //往前直行PID参数
    turn_pid(2.0, 0.05, 0.02, 5.0, 2.0, 15, 8);       //转向指定角度所使用的PID参数                     
...
void usercontrol()
{
    ...
    while (true)
    {
        ...
        // 操作手习惯左摇杆前后，右摇杆转向
        int leftY = Controller1.Axis3.position(percent); // 左摇杆纵向
